// Component for home page (display either logged in or not)
...
class Home extends Component {
  render() {
    ...
    authButtons = (
      <Link id="homeButtons" to="/dashboard" style={{width:"120px"}}>Dashboard{' '}<i className="fas fa-chevron-right"/></Link>
    );
    authWords = (
      <div>
